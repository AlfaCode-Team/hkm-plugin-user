...
import Page from "../admin/Pages/User/Show";
import fixture from "../__fixtures__/user-show.json";

/**
 * Component test for `User/Show`.
 *
 * Props come from __fixtures__/user-show.json, which a ground test dumped
 * from a REAL response:
 *
 *   $this->ground()->pageflow('/your/route')
 *       ->writeFixture(__DIR__ . '/../ui/__fixtures__/user-show.json');
 *
...
describe.skipIf(pending)("User/Show", () => {
