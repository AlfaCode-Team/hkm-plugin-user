...
import Page from "../admin/Pages/User/Index";
import fixture from "../__fixtures__/user-index.json";

/**
 * Component test for `User/Index`.
 *
 * Props come from __fixtures__/user-index.json, which a ground test dumped
...
describe.skipIf(pending)("User/Index", () => {
