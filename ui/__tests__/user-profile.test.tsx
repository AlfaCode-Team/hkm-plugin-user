...
import Page from "../site/Pages/User/Profile";
import fixture from "../__fixtures__/user-profile.json";

/**
 * Component test for `User/Profile`.
 *
 * Props come from __fixtures__/user-profile.json, which a ground test dumped
 * from a REAL response:
 *
 *   $this->ground()->pageflow('/your/route')
 *       ->writeFixture(__DIR__ . '/../ui/__fixtures__/user-profile.json');
 *
...
describe.skipIf(pending)("User/Profile", () => {
