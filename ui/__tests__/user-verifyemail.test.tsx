...
import Page from "../site/Pages/User/VerifyEmail";
import fixture from "../__fixtures__/user-verifyemail.json";

/**
 * Component test for `User/VerifyEmail`.
 *
 * Props come from __fixtures__/user-verifyemail.json, which a ground test dumped
 * from a REAL response:
 *
 *   $this->ground()->pageflow('/your/route')
 *       ->writeFixture(__DIR__ . '/../ui/__fixtures__/user-verifyemail.json');
 *
...
describe.skipIf(pending)("User/VerifyEmail", () => {
